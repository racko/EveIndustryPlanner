#include "libs/access_token/access_token.h"
...
struct workspace {
    ...
    HTTPSRequestHandler
        request_handler; // TODO: replace with "sequential" request handler to be able to deal with errors
    workspace() : request_handler("login.eveonline.com", 443) {}

    void step1() {
        auto path = "/oauth/authorize/"
                    "?response_type=token&client_id=6207584877514be8b23ab78a6163bb82&scope=publicData&redirect_uri="
                    "https://racko.pw:51230";
    ...
    void step2() {
        auto path =
            "/Account/"
            "LogOn?ReturnUrl=%2Foauth%2Fauthorize%2F%3Fresponse_type%3Dtoken%26client_id%"
            "3D6207584877514be8b23ab78a6163bb82%26scope%3DpublicData%26redirect_uri%3Dhttps%3A%2F%2Fracko.pw%3A51230";
    ...
    std::string step3() {
        auto path =
            "/Account/"
            "Authenticator?ReturnUrl=%2Foauth%2Fauthorize%2F%3Fresponse_type%3Dtoken%26client_id%"
            "3D6207584877514be8b23ab78a6163bb82%26scope%3DpublicData%26redirect_uri%3Dhttps%3A%2F%2Fracko.pw%3A51230";
    ...
    std::string step4(const std::string& requestVerificationToken) {
        auto path = "/oauth/authorize/"
                    "?response_type=token&amp;client_id=6207584877514be8b23ab78a6163bb82&amp;scope=publicData&amp;"
                    "redirect_uri=https://racko.pw:51230";
        const std::string data =
            "ClientIdentifier=6207584877514be8b23ab78a6163bb82&RedirectUri=https://"
            "racko.pw:51230&State=&Scope=publicData&ResponseType=token&__RequestVerificationToken=" +
            requestVerificationToken + "&CharacterId=1679728731";
        ...
        RequestWithPolicy request4(
            Request::Method::POST,
            path,
            policy,
            Request::OnRedirect::DONT_FOLLOW); // don't follow: We need to read the target location below
